...
void new_TightDataPointStorageD(TightDataPointStorageD **this, 
	...
	*this = (TightDataPointStorageD *)malloc(sizeof(TightDataPointStorageD));
	...
	if ((*this)->entropyType == 0) {
        ...
        memcpy((*this)->typeArray, temp, sizeof(unsigned short) * dataSeriesLength); 
        (*this)->typeArray_size = dataSeriesLength * 2;
        //printf("[none]: \t\tratio=%f, outsize=%lu", (dataSeriesLength * 8.0) / (*this)->typeArray_size, (*this)->typeArray_size);
		free(temp);
	}
	else {
		// fse
